...
public class UpdateQuotationDTO {
	...
	public UpdateQuotationDTO(Integer quotationId, Integer userId, Integer customerId, Integer discountId,
			String remitter, LocalDate dateQuotation, LocalDate dateEvent, String reference,
			Double net, Double iva, Double total, List<UpdateItemDTO> items) {
		super();
